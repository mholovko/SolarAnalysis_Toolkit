...
using BH.Adapter;
using BH.Engine.SolarAnalysis;

namespace BH.Adapter.SolarAnalysis
{
    public partial class SolarAnalysisAdapter : BHoMAdapter
    {
        ...
        public SolarAnalysisAdapter()
        {
            AdapterId = BH.Engine.SolarAnalysis.Convert.AdapterId;   //Sets` the "AdapterId" to "SoftwareName_id". Generally stored as a constant string in the convert class in the SoftwareName_Engine
